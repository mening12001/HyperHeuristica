...
from hyperheuristic.orchestrator.SSAOrchestrator2 import SSAOrchestrator2


class ESSAHyperHeuristic2(HyperHeuristic):
    ...
    def optimize(self, objective_func, dimensions, bounds, nr_hypergenerations = 40):
        ...
        num_genes = 3
        window_size = 5
        orchestrator = SSAOrchestrator2(objective_func=objective_func, dimensions=dimensions, bounds=bounds,
