...
class GA:
    ...
    def run(self):
        ...
        self.last_generation_fitness = self.cal_pop_fitness(generation=0)
        ...
        for generation in range(0, self.num_generations):
            ...
            # Measuring the fitness of each chromosome in the population. Save the fitness in the last_generation_fitness attribute.
            self.last_generation_fitness = self.cal_pop_fitness(generation=generation)
    ...
    def best_solution(self, pop_fitness=None):
        ...
        if pop_fitness is None:
            pop_fitness = self.cal_pop_fitness(generation=self.num_generations-1)
