...
class BaseSSA(Optimizer):
    ...
    def __init__(self, id, problem, window_size=10000, pop_size=100, ST=0.8, PD=0.2, SD=0.1, **kwargs):
        """
        Args:
        ...
        self.ST = self.validator.check_float("ST", float(ST), (0, 1.0))
        self.PD = self.validator.check_float("PD", float(PD), (0, 1.0))
        self.SD = self.validator.check_float("SD", float(SD), (0, 1.0))
...
class SSAAgent(BaseSSA):
    ...
    def __init__(self, id, problem, window_size=10000, pop_size=100, ST=0.8, PD=0.2, SD=0.1, **kwargs):
        ...
        Args:
            ...
            SD (float): number of sparrows who perceive the danger, default = 0.1
        """
        super().__init__(id, problem, window_size, pop_size, ST, PD, SD, **kwargs)
